...
export function AutoUnsubscribe(): any {
  return function (targetClass: any, key: string, descriptor: any): void {
    // @ts-ignore
  ...
  if (!descriptor) {
    descriptor = {
      ...
      set: function (newValue: Observable<unknown>): void {
        ...
        defineSubscribeForMethod.call(this, 'asObservable' as keyof Observable<unknown>, newValue);
  ...
  if (originalMethod) {
    descriptor.value = function (...args: unknown[]): unknown {
      ...
      if (result.subscribe) {
        ...
        defineSubscribeForMethod.call(this, 'asObservable' as keyof Observable<unknown>, result);
      } else {
